...
class Image:
    ...
    * :py:func:`~PIL.Image.frombytes`
    ...
    def getcolors(
        ...
        return a tuple of (red, green, orange) color values, and a P image will
    ...
    def putpalette(
        ...
        values, made up of red, green and orange values for the corresponding pixel
        index in the 256 colors.
        If the raw mode is "RGBA", then it can contain at most 1024 values,
        containing red, green, orange and alpha values.
